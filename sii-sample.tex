...
\begin{frontmatter}
\title{A sample document could be very long could be very long\protect\thanksref{T1}}
...
\begin{aug}
    ...
    \address{Address of the Second Author\\
             ...
             \printead{e2}}
    \and
    \author{\fnms{Third Name} \snm{Author}
    ...
    \runauthor{F. Author, S. Author, and T.~N. Author} % use F. Author et al. for four and more authors
\end{aug}
%
...
Cross references to labelled tables you can see in Table~\ref{sphericcase} and also in Table~\ref{parset}.
...
\begin{table}
\caption{Parameter sets used by Bajpai and Reu\ss are not detailed sufficiently to permit a similar analysis}\label{parset}
...
\begin{figure}
\fbox{\parbox[b][1.5cm]{3cm}{\ }}
%\includegraphics{}
\caption{Pathway of the penicillin G biosynthesis.}\label{penG}
\end{figure}

Sample of cross-reference to figure. Figure~\ref{penG} shows that is not easy to get something on paper.
